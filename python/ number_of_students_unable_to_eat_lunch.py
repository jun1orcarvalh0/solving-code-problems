...
class Solution:
    def countStudents(self, students: list[int], sandwiches: list[int]) -> int:
        circular_students_count = 0
        square_students_count = 0
        
        for student in students:
            if student == 0:
                circular_students_count += 1
            else:
                square_students_count += 1
        
        for sand in sandwiches:
            if sand == 0 and circular_students_count == 0:
                return square_students_count
            
            if sand == 1 and square_students_count == 0:
                return circular_students_count
